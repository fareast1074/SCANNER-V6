# GRID V2.5 Calibration Inventory System
...
- `enhancements.js` — V2.5 workflow, interface, import, scanner, and reporting upgrades.
- `style.css` — complete responsive V2.5 styling.
